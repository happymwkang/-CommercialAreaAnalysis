...
<body>
			...
			<div class="row">
					...
					<div class="single-editors-pick-area wow fadeInUp"
						...
						<div class="editors-pick-info">
							<div class="places-total-destinations d-flex">
								<a href="#">New York</a> <a href="#">1643 Destinations</a>
							</div>
							<div>
				...
				<div class="col-12 col-lg-6">
					<div class="single-editors-pick-area wow fadeInUp"
						...
						<div class="editors-pick-info">
							<div class="places-total-destinations d-flex">
								<a href="#">Barcelona</a> <a href="#">943 Destinations</a>
							</div>
							<div class="add-more">
								<a href="#">+</a>
							</div>
					...
					<div class="single-editors-pick-area wow fadeInUp"
						...
						<div class="editors-pick-info">
							<div class="places-total-destinations d-flex">
								<a href="#">paris</a> <a href="#">243 Destinations</a>
							</div>
							<div class="add-more">
								<a href="#">+</a>
							</div>
	...
	<section class="dorne-features-destinations-area" style="">
					...
					<div class="features-slides owl-carousel">
						...
						<div class="single-features-area">
							...
							<div class="ratings-map-area d-flex">
								<a href="#">8.5</a> <a href="#"><img
									src="img/core-img/map.png" alt=""></a>
							</div>
							<div
						...
						<div class="single-features-area">
							...
							<!-- Rating & Map Area -->
							<div class="ratings-map-area d-flex">
								<a href="#">8.2</a> <a href="#"><img
									src="img/core-img/map.png" alt=""></a>
							</div>
							<div
								class="feature-content d-flex align-items-center justify-content-between">
								<div class="feature-title">
									<h5>Jimâs corner Pub</h5>
									<p>Madrid</p>
								</div>
								<div class="feature-favourite">
									<a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
